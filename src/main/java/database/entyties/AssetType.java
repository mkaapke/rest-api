...
public class AssetType {
    ...
    @Id
    @Column(name = "idAssetType", nullable = false)
    ...
    public boolean equals(Object o) {
        ...
        if (idAssetType != assetType.idAssetType) return false;
        if (name != null ? !name.equals(assetType.name) : assetType.name != null) return false;
        if (description != null ? !description.equals(assetType.description) : assetType.description != null)
            return false;

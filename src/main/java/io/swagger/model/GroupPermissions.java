...
public class GroupPermissions   {
  ...
  public GroupPermissions id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public GroupPermissions name(String name) {
    this.name = name;
    return this;
  }
   ...
   * @return name
  **/
  @ApiModelProperty(example = "CREATE USER", required = true, value = "")
  @NotNull
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, groupPermissions.id) &&
        Objects.equals(this.name, groupPermissions.name);
  }
